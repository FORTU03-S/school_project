    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_type', models.CharField(choices=[('ABSENCE', 'Absence Enfant'), ('EVALUATION', 'Évaluation à venir'), ('HOMEWORK', 'Devoir à faire'), ('MESSAGE_TEACHER', "Message de l'enseignant"), ('PAYMENT', 'Statut de Paiement'), ('REPORT_CARD', 'Bulletin Scolaire'), ('GENERAL', 'Général')], max_length=50, verbose_name='Type de notification')),
