    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teachers', models.ManyToManyField(blank=True, limit_choices_to={'user_type': 'TEACHER'}, related_name='classes_taught', to=settings.AUTH_USER_MODEL, verbose_name='Enseignants de la Classe')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('classes', models.ManyToManyField(blank=True, related_name='courses_taught', to='school.classe', verbose_name='Classes Associées')),
                ...
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='courses', to='school.school', verbose_name='École')),
            ],
            options={
                'verbose_name': 'Cours',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', models.CharField(choices=[('PENDING', 'En attente'), ('COMPLETED', 'Complet'), ('PARTIAL', 'Partiel'), ('OVERPAID', 'Surpayé')], default='COMPLETED', max_length=10, verbose_name='Statut du Paiement')),
                ('transaction_id', models.CharField(blank=True, max_length=255, null=True, verbose_name='ID Transaction')),
                ('receipt_number', models.CharField(blank=True, max_length=50, null=True, unique=True, verbose_name='Numéro de Reçu')),
                ('receipt_file', models.FileField(blank=True, null=True, upload_to='receipts/', verbose_name='Fichier Reçu PDF')),
                ('academic_period', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school.academicperiod', verbose_name='Période Académique')),
                ('fee_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='school.feetype', verbose_name='Type de Frais Payé')),
                ...
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='profiles.student', verbose_name='Élève')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='school',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='academic_periods', to='school.school', verbose_name='École'),
        ),
        migrations.CreateModel(
            name='Subject',
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True, verbose_name='Description')),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subjects', to='school.school', verbose_name='École')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enrollment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attendances_related', to='school.enrollment', verbose_name='Inscription')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='report_cards_generated', to='school.school', verbose_name='École')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='class_assignments', to='school.school', verbose_name='École')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fee_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school.feetype', verbose_name='Type de Frais')),
                ('set_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Défini par')),
            ],
            options={
